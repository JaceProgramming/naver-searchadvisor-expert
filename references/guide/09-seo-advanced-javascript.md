...
참고로 네이버 검색 로봇은 자바스크립트와 같이 보조적 리소스 정보를 수집하려는 경우 브라우저 User-Agent에 예시와 같이 특징적 문자열(Yeti 등)이 추가되는 경우가 있습니다. 구체적 버전 등 수시로 변경될 수 있으며 보다 자세한 정보는 [검색로봇 확인 방법](https://searchadvisor.naver.com/guide/seo-basic-firewall)을 참고하세요.
